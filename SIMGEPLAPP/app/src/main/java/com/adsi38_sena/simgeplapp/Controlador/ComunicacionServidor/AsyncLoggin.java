...
public class AsyncLoggin extends AsyncTask<String, String, Boolean> {
    ...
    protected void onPreExecute() {
        ...
        dialogo_carga.show(myActy.getFragmentManager(), SIMGEPLAPP.TAG_FRAG_LOGGIN);
    }
    ...
    protected void onPostExecute(Boolean result) {
        if(myActy != null) {
            ...
            dialogo_carga.dismiss(myActy.getFragmentManager());
        }

            GestionCargas.obtenerInstancia().removerProcesoLoggin(SIMGEPLAPP.LLAVE_PROCESO_LOGIN);
    }
